...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      { 
        path: 'dashboard',name: 'Index', component: () => import('pages/IndexPage.vue'),
      ...
      {
        path: 'users/:id', name:'Users-Information', component: () => import('src/modules/admin/patients/components/UserComponent.vue') ,
        meta: { requiresAuth: true, roles: ['admin'] },        
      },
      { 
